...
| File | Content |
|---|---|
| `NL-single-family-house_LOD0_STEP.stp` | LoD0 footprint (single MultiSurface). |
| `NL-single-family-house_LOD1_STEP.stp` | LoD1 generic extrusion (one Solid). |
| `NL-single-family-house_LOD2_STEP.stp` | LoD2 faceted exterior with thematic surfaces (Wall / Roof / Ground). |
| `NL-single-family-house_LOD3_STEP.stp` | LoD3 detailed exterior with windows and doors. |
| `NL-single-family-house_ZonePart1_STEP.stp` | LoD3 geometry for thermal zone part 1. |
| `NL-single-family-house_ZonePart2_STEP.stp` | LoD3 geometry for thermal zone part 2. |
