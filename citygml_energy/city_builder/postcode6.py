...
_CBS_QUALITY_DESCRIPTION: str = (
    ...
    "exclude self-generated electricity (e.g. from solar panels) and "
            ...
            Resource(
                energy=_build_cbs_energy(
                    ...
                    description=(
                        ...
                        "excludes self-generated electricity (e.g. from "
                        "solar panels) and collective consumption. "
                        "Negative amounts are CBS sentinels "
